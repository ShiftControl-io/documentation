---
title: 'AWS'
description: 'Configure AWS SSO and user sync with ShiftControl. Set up single sign-on, group sync, and role-based access for your AWS accounts.'
keywords: ['ShiftControl', 'AWS', 'SSO', 'app guide', 'configuration', 'single sign-on', 'user sync']
icon: 'aws'
---
