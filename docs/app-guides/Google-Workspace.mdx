...
description: 'Configure Google Workspace SSO and user sync with ShiftControl. Set up single sign-on, directory integration, and license management.'
keywords: ['ShiftControl', 'Google Workspace', 'SSO', 'app guide', 'configuration', 'cloud directory', 'identity provider']
icon: 'google'
---
