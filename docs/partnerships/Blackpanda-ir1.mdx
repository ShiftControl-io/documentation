...
description: 'Learn about the Blackpanda IR-1 incident response partnership available to ShiftControl customers for expert-led cyber incident recovery.'
keywords: ['ShiftControl', 'Blackpanda', 'incident response', 'IR-1', 'partnerships', 'cyber security', 'digital forensics']
---
