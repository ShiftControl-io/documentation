---
title: 'Dream Team'
description: 'Integrate Dream Team with ShiftControl to sync HR data, automate user lifecycle management, and save on JumpCloud license costs.'
keywords: ['ShiftControl', 'Dream Team', 'connector', 'integration', 'setup guide', 'HRIS', 'user management']
icon: 'users'
---
...
<Steps>
    ...
    <Step title="Copy Access and Refresh Tokens">
        ...
        <img src="/img/ShiftControl/Integrations/DreamTeam/DreamTeam-tokens-light.webp" alt="DreamTeam Tokens" width="500" />
    </Step>
