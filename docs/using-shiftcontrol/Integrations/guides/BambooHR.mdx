---
title: 'BambooHR'
description: 'Integrate BambooHR with ShiftControl to sync HR data, automate user lifecycle management, and save on JumpCloud license costs.'
keywords: ['ShiftControl', 'BambooHR', 'connector', 'integration', 'setup guide', 'HRIS', 'user management']
icon: 'users'
---
...
The BambooHR connector allows you to connect your BambooHR system to ShiftControl, enabling HR data to become the single source of truth for user management across your organization. This connector streamlines user provisioning, updates, and lifecycle management based on your HR records.
...
Our BambooHR connector offers several improvements over JumpCloud's native connector:
...
Before setting up the connector in ShiftControl, you need to create an API key in BambooHR:
...
<Steps>
    ...
    <Step title="Navigate to API Keys">
        ...
        <img src="/img/ShiftControl/Integrations/BambooHR/BambooHR-my-account-light.webp" alt="BambooHR Account Menu" width="300" />
    </Step>

    <Step title="Add New Key">
        Click Add New Key
        
        <img src="/img/ShiftControl/Integrations/BambooHR/BambooHR-add-key-light.webp" alt="BambooHR Add New Key" width="300" />
    </Step>
    ...
    <Step title="Name the API Key">
       Enter `ShiftControl` as the name for the API key in the API Key Name field and click Generate Key
        ...
        <img src="/img/ShiftControl/Integrations/BambooHR/BambooHR-name-key-light.webp" alt="BambooHR Name API Key" width="500" />
    </Step>

    <Step title="Copy the API Key">
        Click COPY KEY to copy the key to the clipboard
        
        <img src="/img/ShiftControl/Integrations/BambooHR/BambooHR-copy-key-light.webp" alt="BambooHR Copy API Key" width="500" />
    </Step>
