...
description: 'Authorize ShiftControl connectors using API keys or OAuth credentials. Add, update, and securely manage connector authentication.'
keywords: ['ShiftControl', 'connector', 'authorization', 'OAuth', 'API key', 'integration', 'credentials']
...
<Steps>
    ...
    <Step title="Provide the API Key">
        ...
        <img src="/img/ShiftControl/Integrations/Integration-add-API-key-light.webp" alt="Connector API Key" />
    </Step>
...
<Steps>
    ...
    <Step title="Return to ShiftControl">
        ...
        like the one below:
        <img src="/img/ShiftControl/Integrations/Intgration-oAuth-success-light.webp" alt="OAuth Authorization Success" />
    </Step>
