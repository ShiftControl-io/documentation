...
- **App category** -- Focus on communication, CRM, productivity, or other app types
...
- [Integration Management](/using-shiftcontrol/Integrations/Integration-management) -- Configure the Google Workspace integration that feeds this dashboard
