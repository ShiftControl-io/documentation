...
<p style={{fontSize: "large"}}>An overview of the ShiftControl Dashboard, allowing you to quickly view and manage groups, users, and apps.</p>
...
<img
    src="/img/ShiftControl/ShiftControl-Dashboard.png"
