...
keywords: ['ShiftControl', 'command bar', 'search', 'navigation', 'keyboard shortcuts', 'productivity']
...
<ModeScreenshot path="General/Command-bar" alt="ShiftControl Command Bar" />
