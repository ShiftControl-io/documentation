...
<ModeScreenshot path="Users/User-detail-google-section" alt="Google Workspace section with recovery email, phone, and directory settings" modes={["jc-google", "google-jc"]} />
...
<ModeScreenshot path="Users/User-detail-app-permissions" alt="App Permissions tab showing active OAuth grants" modes={["jc-google", "google-jc", "google-only"]} />
...
5. **Devices** — the devices bound to this person appear on their profile. Before you deactivate them, follow the [device offboarding steps](/using-shiftcontrol/Devices/Device-actions) — capture the recovery key first, then un-manage or erase the hardware.
...
- [Device Management](/using-shiftcontrol/Devices/Device-management/) — See and manage the devices assigned to this person (JumpCloud)
