...
description: 'Edit user profiles, review security posture, audit OAuth permissions, and track per-user SaaS spend in ShiftControl settings.'
keywords: ['ShiftControl', 'user management', 'edit user', 'identity', 'profile', 'permissions']
icon: 'user-gear'
---
