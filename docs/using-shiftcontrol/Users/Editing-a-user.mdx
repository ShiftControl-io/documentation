...
Changes you make to the Details tab sync back to JumpCloud, which propagates them to connected applications. Security and App Permissions are read-only views that reflect the current state of the user's accounts.
...
<Steps>
    ...
    <Step title="Edit profile details (Details tab)">
        ...
        Click **Save Changes** after making edits. Changes sync to JumpCloud and propagate to connected applications.
    </Step>
