...
1. **A JumpCloud identity is created.** The user's profile, including their name, email, and organizational details, is synced to JumpCloud as the source of truth for authentication.
...
<Steps>
    ...
    <Step title="Save the user">
        Click **Save Changes** to create the user. ShiftControl syncs the new identity to JumpCloud, evaluates group membership rules, provisions app access, and sends the activation email. The user will appear in the Users list with an Inactive status until they complete activation.
    </Step>
