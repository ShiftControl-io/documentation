...
description: 'Complete your ShiftControl setup after onboarding. Organize user groups, configure SSO apps, enable MFA, and prepare your team.'
keywords: ['ShiftControl', 'onboarding', 'post-onboarding', 'setup', 'user groups', 'SSO', 'deployment']
icon: 'bullseye-arrow'
---
