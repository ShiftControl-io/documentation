...
description: 'Configure Google Workspace as an identity provider for JumpCloud through ShiftControl. Enable federated authentication with Google credentials.'
keywords: ['ShiftControl', 'JumpCloud', 'Google Workspace', 'identity provider', 'IdP', 'SSO', 'authentication']
icon: 'google'
---
