...
<Admonition type="tip" title="Connecting Google Workspace?">
    The [Google Workspace App Authorization](/using-shiftcontrol/Integrations/guides/Google-Workspace-App-Authorization/) page explains every scope ShiftControl requests, the consent screen, and how to delegate authorization to a Google Workspace Super Admin via a 48-hour link if you're not the Super Admin yourself.
</Admonition>
