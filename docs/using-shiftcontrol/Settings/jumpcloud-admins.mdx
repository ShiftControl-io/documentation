...
description: 'View and manage JumpCloud admin accounts in ShiftControl. Monitor MFA status, API access, and roles for secure directory integration.'
keywords: ['ShiftControl', 'settings', 'JumpCloud', 'admin accounts', 'integration', 'configuration']
icon: 'cloud'
---
...
<Admonition type="info">
    This page applies to organizations with JumpCloud connected. If you're using Google Workspace only, you can skip this section. See [Google Workspace Admins](/using-shiftcontrol/Settings/google-admins/) instead.
</Admonition>
</ConditionalContent>

<ConditionalContent modes={["jc-google", "google-jc"]}>
<Admonition type="info">
    This page manages JumpCloud admin accounts specifically. For Google Workspace admin management, see [Google Workspace Admins](/using-shiftcontrol/Settings/google-admins/).
</Admonition>
</ConditionalContent>
...
<ModeScreenshot path="Settings/JumpCloud-admins" alt="JumpCloud Admins page showing admin accounts with MFA status and API access" />
...
<ModeScreenshot path="Settings/Settings-create-edit-a-jumpcloud-admin" alt="Create JumpCloud Admin form" modes={["jc-google", "jc-only", "google-jc"]} />
