...
keywords: ['ShiftControl', 'settings', 'connectors', 'SaaS integration', 'app connectors', 'configuration']
icon: 'plug'
---
...
<ModeScreenshot path="Settings/Settings-app-connectors" alt="App connectors list view" />
