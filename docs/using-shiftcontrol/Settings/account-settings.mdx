...
description: 'View your ShiftControl profile, manage security settings, and review authentication methods from the Account Settings page.'
...
<ModeScreenshot path="Settings/Account-settings" alt="Account settings view" />
