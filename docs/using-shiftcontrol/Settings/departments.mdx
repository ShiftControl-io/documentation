...
<ModeScreenshot path="Settings/Settings-departments" alt="Departments list view" />
...
<ModeScreenshot path="Settings/Settings-create-edit-a-department" alt="Add or edit a department" />
