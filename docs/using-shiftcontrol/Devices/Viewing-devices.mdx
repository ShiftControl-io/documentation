...
The **Needs attention** view is a pre-built filter for the devices most likely to need action — unencrypted, dormant, or unassigned — so you don't have to assemble it yourself.
