...
Device Management is **automatically enabled for all JumpCloud customers** — there's nothing to install or turn on. If you'd prefer to hide it, go to **Settings → Features** and toggle Devices off.
