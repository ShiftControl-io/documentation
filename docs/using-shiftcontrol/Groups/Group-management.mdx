...
- **Groups sync to JumpCloud.** ShiftControl groups are pushed to your JumpCloud directory, so group membership changes propagate to any JumpCloud-integrated systems.
