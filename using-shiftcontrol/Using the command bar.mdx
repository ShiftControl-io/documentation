...
<img
    src="/images/ShiftControl/Command bar.png"
...
| `a` then `u`         | Navigate to Add User                 |
| `a` then `g`         | Navigate to Add Group                |
| `a` then `a`         | Navigate to Add App                  |
| `g` then `u`         | Navigate to Manage Users             |
| `g` then `g`         | Navigate to Manage Groups            |
| `g` then `a`         | Navigate to Manage Apps              |
| `a` then `d`         | Navigate to App Discovery            |
| `a` then `i`         | Navigate to Integrations             |
