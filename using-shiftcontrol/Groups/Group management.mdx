...
<img
    src="/images/ShiftControl/Groups/Group Management.png"
...
Clicking the [Add Group](/using-shiftcontrol/Groups/Adding%20a%20group) button located at the top of the screen to create a new group. This opens a form where you can input the group's name, description, and other settings.

## Editing a Group

Clicking the [Edit](/using-shiftcontrol/Groups/Editing%20a%20group) button next to any group in the list will take you to the group details page, where you can modify its information. We will cover the specific details in a separate section.
...
<img
    src="/images/ShiftControl/Groups/Group membership quick view.png"
