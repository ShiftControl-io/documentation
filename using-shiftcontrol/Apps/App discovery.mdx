...
<img
    src="/images/ShiftControl/Apps/App discovery.png"
    alt="App Discovery"
/>
...
<img
    src="/images/ShiftControl/Apps/App Assignment details.png"
    alt="App Discovery details"
/>

## Adding a Discovered App

Clicking the [Add to apps](/using-shiftcontrol/Apps/Adding%20an%20app) button next to any discovered app will take you to the app catalog, where you can add the app to your organization. You can configure the app settings, assign groups, and make it available to users in the employee portal.
...
<img
    src="/images/ShiftControl/Apps/App discovery bulk actions.png"
