...
<Accordion title="Google will only provision a user if licenses are available">
  If you find that you have created a user but they don't have an account automatically created in Google Workdspace, please check to make sure that you have enough licenses to add more users.
  If you don't, you'll need to first add/purchase licenses before the user will sync in.
  <Note>In many cases, especially if you are on an annual plan, adding a licenses incurs costs. Be sure you are ready to use the license before you add it, as you will not be able to reduce the license until your annual renewal on annual plans.</Note>
</Accordion>
...
<Accordion title="Google does not enforce SSO for Admins">
  ...
  This is an odd choice by Google, but something you should be aware of. Depanding on your SSO configuration, the admin experience will differ.
...
<Accordion title="We always recommend having a separate admin account to administer Google Workspace">
 ...
 <Info>Adding additional admins incurs regular user costs. We think this extra cost is worth is, and you should limit the users who have admin anyways!</Info>
</Accordion>
...
<Steps>
  ...
  <Step title="Create an OU">
    ...
    <Note>If you already have OUs setup, you may choose to put this somewhere that makes more sense for your structure.</Note>
    <img
