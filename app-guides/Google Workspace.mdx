...
<Accordion title="Google will only provision a user if licenses are available">
    If you find that you have created a user but they don't have an account automatically created in Google Workspace,
    please check to make sure that you have enough licenses to add more users.
    If you don't, you'll need to first add/purchase licenses before the user will sync in.
    <Note>In many cases, especially if you are on an annual plan, adding a licenses incurs costs. Be sure you are ready
        to use the license before you add it, as you will not be able to reduce the license until your annual renewal on
        annual plans.</Note>
</Accordion>

<Accordion title="Google does not enforce SSO for Admins">
    If you are using a Google account that has an Administrator role then Google will not enforce SSO in order to make
    sure that admins aren't locked out of Google.

    This is an odd choice by Google, but something you should be aware of. Depending on your SSO configuration, the
    admin experience will differ.
...
<Accordion title="We always recommend having a separate admin account to administer Google Workspace">
    Google Workspace is likely one of your more sensitive SaaS services. It contains not only your entire user
    directory, but also many sensitive emails, documents, and more.

    We highly recommend avoiding using your normal "Daily Driver" Google account for administrating Google Workspace.
    Keep a separate account with a very strong password in a password manager and use it as needed. You can forward the
    emails from your admin account to your main account to keep up to date on notifications.

    This type of admin separation is recommended because your main account can get compromised and they won't be able to
    completely compromise your environment. It also gives admins a better user experience because of the way SSO works
    in Google Workspace.

    <Info>Adding additional admins incurs regular user costs. We think this extra cost is worth is, and you should limit
        the users who have admin anyways!</Info>
</Accordion>
...
<Steps>
    ...
    <Step title="Manage OUs">
        ...
        <img
            src="/images/App-Guides/Google/Google - Organizational Units.png"
    ...
    <Step title="Create an OU">
        ...
        <Note>If you already have OUs setup, you may choose to put this somewhere that makes more sense for your
            structure.</Note>
        <img
            src="/images/App-Guides/Google/Google - Create organizational unit.png"
...
<Steps>
    ...
    <Step title="Add SAML profile">
        ...
        <img
            src="/images/App-Guides/Google/Google - Add SAML profile.png"
    ...
    <Step title="Configure the SAML profile">
        ...
        <ol>
            ...
            <li>Sign-in Page URL: The “IDP URL” from the app’s SSO page in JumpCloud (Soon to be shown in
                ShiftControl)
            </li>
            <li>Sign-out page URL: https://console.jumpcloud.com</li>
            <li>Change password URL: https://console.jumpcloud.com</li>
            <li>Upload the certificate: Found by clicking Download certificate on the left in the app’s SSO page in
                JumpCloud (Soon to be available in ShiftControl)
            </li>
        </ol>
        <img
            src="/images/App-Guides/Google/Google - Download Certificate.png"
    ...
    <Step title="Save the profile">
        Click Save
        <img
            src="/images/App-Guides/Google/Google - Save SAML profile.png"
    ...
    <Step title="Review the configuration page">
        ...
        <img
            src="/images/App-Guides/Google/Google - Review configuration.png"
            alt="Save SAML profile"
        />
    </Step>
    <Step title="Copy the SP Entity ID">
        ...
        <img
            src="/images/App-Guides/Google/Google - Copy SP Entity ID.png"
    ...
    <Step title="Copy the ACS Url">
        ...
        <img
            src="/images/App-Guides/Google/Google - Copy ACS Url.png"
...
<Steps>
    ...
    <Step title="Click on Get Started">
        ...
        <img
            src="/images/App-Guides/Google/Google - Get Started.png"
            alt="Get Started"
        />
    </Step>
    ...
    <Step title="Set Google prompt for username">
        Keep the default of “Have Google prompt for their username, then redirect them to this profile's IDP sign-in
        page”
    </Step>
    <Step title="Click Override">
        Then click Override
        <img
            src="/images/App-Guides/Google/Google - Click Override.png"
            alt="Click Override"
        />
    </Step>
...
<Steps>
    ...
    <Step title="Change organizational unit">
        ...
        <img
            src="/images/App-Guides/Google/Google - Change organizational unit.png"
    ...
    <Step title="Review the warning and click Change">
        Review the warning and click Change, there will be no impact other than SSO if you don’t currently use OUs as
        all other rules are inherited from the main organization.
        <img
            src="/images/App-Guides/Google/Google - Review and Change.png"
