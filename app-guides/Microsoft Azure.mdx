...
<Steps>
  ...
  <Step title="Click on Cloud Directories">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Cloud Directories.png"
  ...
  <Step title="Click on the Plus (+) and choose Entra ID/Azure AD">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Select Entra ID-Azure AD.png"
  ...
  <Step title="Name your directory">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Name Directory.png"
  ...
  <Step title="Sign in to Microsoft">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Sign In.png"
  ...
  <Step title="Accept the permission request">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Permission Request.png"
  ...
  <Step title="Review the list of users">
    ...
    <img
      src="images/App-Guides/Azure/Azure - User List.png"
  ...
  <Step title="Save and close">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Save Close.png"
      alt="Save and close"
    />
  </Step>
</Steps>
...
<Note>Groups are not synced over to Azure, only the users in the group are synced.</Note>
...
<Steps>
  ...
  <Step title="Click Add new app">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Add New App.png"
  ...
  <Step title="Search for Microsoft and add SSO app">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Add SSO App.png"
  ...
  <Step title="Save the settings">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Save Settings.png"
  ...
  <Step title="Edit the app to download metadata">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Download Metadata.png"
...
<Steps>
  ...
  <Step title="Accept the permission request">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Accept Permission Request.png"
      alt="Accept the permission request"
    />
  </Step>
  <Step title="Authentication complete notice">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Authentication Complete.png"
  ...
  <Step title="Show SSO configuration">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Accept Permissions.png"
...
<img
  src="images/App-Guides/Azure/Azure - User Email.png"
...
<img
  src="images/App-Guides/Azure/Azure - User Notice.png"
...
<Steps>
  <Step title="Console with Azure app">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Console with App.png"
  ...
  <Step title="Select the right user">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Select User.png"
  ...
  <Step title="Redirect to JumpCloud login">
    ...
    <img
      src="images/App-Guides/Azure/Azure - JumpCloud Login.png"
  ...
  <Step title="Choose to remain signed in">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Remain Signed In.png"
  ...
  <Step title="Logged in via SSO">
    ...
    <img
      src="images/App-Guides/Azure/Azure - Logged In via SSO.png"
